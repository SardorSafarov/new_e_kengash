...
class CouncilViewModel(private val councilRepository: CouncilRepository): ViewModel() {
    ...
    fun changeDeputatArticle(id:String,onResponse: (response: Response<ChangeDeputatArticleResponse>) -> Unit)
    {
        viewModelScope.launch {
            try {
    ...
    fun changeDeputatActivity(id:String,onResponse: (response: Response<ChangeDeputatActivityResponse>) -> Unit)
    {
        viewModelScope.launch {
            try {
